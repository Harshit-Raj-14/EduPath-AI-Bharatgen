...
function Footer() {
  return (
    <footer className="flex flex-col justify-between items-center md:flex-row gap-2 w-full p-5">
      <div className="text-center">EduPath AI</div>

      <div className="flex items-center gap-1">
        <a
          href="https://www.facebook.com/edupath-ai"
          type="button"
        ...
        <a
          href="https://www.instagram.com/_edupath-ai"
          type="button"
          className="rounded-full p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-primary/50 focus:outline-none focus:ring-0"
          data-twe-ripple-init
        >
        ...
        <a
          href="https://www.linkedin.com/in/edupath-ai"
          type="button"
          className="rounded-full p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-primary/50 focus:outline-none focus:ring-0"
          data-twe-ripple-init
        >
