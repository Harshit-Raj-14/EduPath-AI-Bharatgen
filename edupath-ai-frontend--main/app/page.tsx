...
export default function Home() {
  ...
  const showSession = () => {
    ...
    if (status === "loading")
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900">
    ...
    return (
      <Flowbite>
        <div className="min-h-screen bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900 overflow-x-hidden">
          {/* Navbar */}
          <Navbar
            fluid
          ...
          >
            ...
            {/* Right side: everything else in a flex container */}
            ...
            <div className="px-6 text-center md:text-left">
              ...
              >
                ...
                <p className="text-xl mb-8 text-gray-600 dark:text-gray-300">
                  Personalized learning paths that adapt to your progress and
          ...
          <motion.section
            ...
            transition={{ duration: 0.6 }}
            className="py-20 bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900"
          >
          ...
          <motion.section
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900 py-20"
          >
                ...
                <Accordion collapseAll>
                  {[
                    ...
                    },
                    {
                      ...
                      answer:
                        "Our platform provides detailed analytics and progress tracking. You can view your performance metrics, completion rates, and improvement areas through your personalized dashboard.",
                    },
                    {
                      question: "How does our AI work?",
                      answer:
                        "Our AI companion adapts to your learning style, providing personalized feedback and guidance throughout your study sessions. It analyzes your performance and adjusts the difficulty level accordingly.",
                    },
                    {
          ...
          >
            <div className="container mx-auto px-4 text-center text-white">
              ...
              <p className="text-lg mb-8 opacity-90">
                Join{" "}
                {Math.floor(Math.random() * 50000 + 10000).toLocaleString()}+
                learners who are already transforming their future with EduPath
                AI
              </p>
          ...
          {/* <motion.section
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900 py-16"
          >
            <div className="container mx-auto px-4">
