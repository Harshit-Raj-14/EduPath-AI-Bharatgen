...
export default function Register() {
  ...
  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900 flex items-center justify-center px-4">
      <motion.div
