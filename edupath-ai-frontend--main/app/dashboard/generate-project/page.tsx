...
export default function ProjectGeneratorPage() {
  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900 flex items-center justify-center">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
  ...
  return (
    <Flowbite>
      <div className="min-h-screen bg-gradient-to-br from-white to-indigo-200 dark:from-gray-900 dark:to-indigo-900 p-6">
            ...
            <Card className="mb-6 shadow-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="mt-6 text-center">
                ...
                >
                  ...
                  {loading ? "Generating Projects..." : "Generate Project"}
                </Button>
              </div>
            </Card>
          </motion.div>
